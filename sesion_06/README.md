...
Un ejemplo de utilidad: Ellas pueden usarse en la construcción de una página como la hecha [la sesión recién pasada](https://github.com/profesorfaco/front-2023-1/tree/main/sesion_05#exploraci%C3%B3n-pr%C3%A1ctica).
